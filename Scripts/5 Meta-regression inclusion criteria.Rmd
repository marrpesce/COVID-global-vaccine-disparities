...
nrow(VEmetareg_data)  #3597 estimates
n_distinct(VEmetareg_data$Study_id_f) #422 studies

## Step 1: exclude studies of infection
VEmetareg_data <- VEmetareg_data %>% 
  filter(outcome_final=="severe" | outcome_final=="death") 
nrow(VEmetareg_data)  #1641 estimates
n_distinct(VEmetareg_data$Study_id_f) #249 studies
...
nrow(VEmetareg_data)  #1229 estimates
n_distinct(VEmetareg_data$Study_id_f) #177 studies
...
nrow(VEmetareg_data) #832
n_distinct(VEmetareg_data$Study_id_f) #128
...
nrow(VEmetareg_data) #484
n_distinct(VEmetareg_data$Study_id_f) #75

## Step 6: exclude products with <10 unique studies
table(VEmetareg_data$clean_vaccine)
n_distinct(subset(VEmetareg_data, clean_vaccine=="Beijing/Sinopharm BBIBP-CorV")$Study_id_f) # 6
n_distinct(subset(VEmetareg_data, clean_vaccine=="Bharat Covaxin/BBV152")$Study_id_f) # 3
n_distinct(subset(VEmetareg_data, clean_vaccine=="BioNTech/Pfizer BNT162b2")$Study_id_f) # 53
n_distinct(subset(VEmetareg_data, clean_vaccine=="Cansino Ad5-nCoV")$Study_id_f) # 2
n_distinct(subset(VEmetareg_data, clean_vaccine=="Gamaleya Gam-COVID-Vac/Sputnik V")$Study_id_f) # 6
n_distinct(subset(VEmetareg_data, clean_vaccine=="Janssen Ad26.COV2.S")$Study_id_f) # 15
n_distinct(subset(VEmetareg_data, clean_vaccine=="Moderna mRNA-1273")$Study_id_f) # 27
n_distinct(subset(VEmetareg_data, clean_vaccine=="Oxford/AstraZeneca ChAdOx1-S")$Study_id_f) # 28
n_distinct(subset(VEmetareg_data, clean_vaccine=="Sinovac CoronaVac")$Study_id_f) # 12
...
#sum(VEmetareg_data$clean_vaccine=="Sinovac CoronaVac" & VEmetareg_data$variant_clean=="alpha")

# criteria met for 7 models in total
# delta/severe - all vaccines
# omicron/severe - BNT162b2, mRNA-1273, and ChAdOx1-S    
...
n_distinct(subset(VEmetareg_data, variant_clean == "omicron" & clean_vaccine == "Janssen Ad26.COV2.S")$Study_id_f) #5
...
VEmetareg_data <- VEmetareg_data %>%
  filter(
    ...
    variant_clean != "alpha" &
    !(variant_clean == "omicron" & clean_vaccine == "Janssen Ad26.COV2.S")
    )
nrow(VEmetareg_data) #225
n_distinct(VEmetareg_data$Study_id_f) #53
