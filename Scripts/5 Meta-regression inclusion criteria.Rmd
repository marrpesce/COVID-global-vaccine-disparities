...
## Filter 2-dose study of Ad26.COV2.S
VEmetareg_data <- VEmetareg_data %>%
    filter(!(clean_vaccine == "Janssen Ad26.COV2.S" & dose_number == "2"))

nrow(VEmetareg_data) #473
n_distinct(VEmetareg_data$Study_id_f) #76
...
n_distinct(subset(VEmetareg_data, clean_vaccine=="Janssen Ad26.COV2.S")$Study_id_f) # 13
...
n_distinct(subset(VEmetareg_data, clean_vaccine=="Abdala (CIBG)")$Study_id_f) # 1
