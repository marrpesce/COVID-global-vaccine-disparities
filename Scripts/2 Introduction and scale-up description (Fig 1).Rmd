...
summary_vacc_intro_scale <- Ineq_vaccine_coverage %>%
  ...
  select(q_GNI_per_c_WB, n, n_intro, introduction, scale_40, scale_70)
...
collated = rbind(
  ...
  Ineq_vaccine_coverage %>% mutate(coverage = `cov_old_cps_2021-12-01`, date = "December 2021", group = "Elderly"),
  Ineq_vaccine_coverage %>% mutate(coverage = `cov_old_cps_2023-12-01`, date = "December 2023", group = "Elderly"),
