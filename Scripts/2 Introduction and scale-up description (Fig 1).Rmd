...
Fig_2 <- Fig_2_a_vac_achiev / Fig_2_b_vac_delay / Fig_2_c_plat
...
#######################################################################################################
##Fig 2. Vaccine coverage in high-risk populations (health care workers and older adults) and overall.#
#######################################################################################################
...
#############################################################
# Extended Data Fig. ?. Scatterplot ... + cor test for lable#
#############################################################
...
# x= GNI + y = date
scatter_milestone_country <- Ineq_vaccine_coverage %>%
...
summary_vacc_intro_scale_d <- Ineq_vaccine_coverage %>%
  ...
  summarize(
    ...
    median_value_1_d = round(median(diff_min_vac_intro_8Dec2020[V1_dummy == "yes"], na.rm = TRUE), 0),
    q25_1_d = round(quantile(diff_min_vac_intro_8Dec2020[V1_dummy == "yes"], 0.25, na.rm = TRUE), 0),
    q75_1_d = round(quantile(diff_min_vac_intro_8Dec2020[V1_dummy == "yes"], 0.75, na.rm = TRUE), 0),
  ...
  mutate(
    introduction_d = paste0(median_value_1_d, " (", q25_1_d, "-", q75_1_d, ")"),
  ...
  select(
    q_GNI_per_c_WB, 
    introduction_d, introduction_date_d,
