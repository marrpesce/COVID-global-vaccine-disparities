...
nrow(VEmetareg_data) # 123 estimtaes after filtering of sequential or nested estimates
...
# Review estimates for which lnRR or SE could not be derived 
excluded_estimates = VEmetareg_data %>% 
  filter(is.na(ln.RR) | is.na(SE.ln.RR))
