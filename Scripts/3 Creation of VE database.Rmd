...
nrow(COVID19VE_country) #3597 estimates
length(unique(COVID19VE_country$Study_id_f)) #422 unique studies
```
...
# Summarise
nrow(COVID19VE_ineq_merged) #3597 estimates
length(unique(COVID19VE_ineq_merged$Study_id_f)) #422 unique studies
```
