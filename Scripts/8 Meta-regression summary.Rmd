...
studies_selected_info <-left_join(studies_selected, metareg_included)  %>% 
...
write.csv(studies_selected_info, "Data/Processed/Extended_Data_all_VE_estimates.csv")
