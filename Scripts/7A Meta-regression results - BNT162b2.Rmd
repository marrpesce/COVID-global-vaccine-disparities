...
# select vaccine
selected_vaccine = "BioNTech/Pfizer BNT162b2" # values: "BioNTech/Pfizer BNT162b2" "Janssen Ad26.COV2.S" "Oxford/AstraZeneca ChAdOx1-S" "Moderna mRNA-1273"
simple_name = "BNT162b2" # for file outputs 

# create logical for whether to run omicron analysis
if (selected_vaccine == "Janssen Ad26.COV2.S") { janssen=TRUE } else { janssen=FALSE}
```
...
# exclude GNI quartile rows for janssen analsys
if (janssen) {
  tabletext = tabletext[-c(2,3,4),]
}
